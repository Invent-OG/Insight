...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative w-full bg-black text-white overflow-hidden">
      {/* Main container with space for content */}
      <div className="relative z-20 max-w-7xl mx-auto flex flex-col justify-center items-center px-4 sm:px-6 lg:px-8 py-6 h-screen">
        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate="visible"
          className="w-full z-200 top-[30%] relative px-4 sm:px-6 lg:px-8"
        >
          <motion.div variants={itemVariants}>
            <FeatureItem
              name="Services"
        ...
        <motion.h1
          variants={itemVariants}
          className="text-5xl md:text-7xl font-mono  mb-2 "
        >
          Insight
        </motion.h1>
        ...
        <motion.h2
          variants={itemVariants}
          className="text-3xl md:text-5xl pb-3 font-mono bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300 bg-clip-text text-transparent"
        >
          Lighting Up The Future
        </motion.h2>
        <motion.button
          ...
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="mt-[100px] sm:mt-[10px] px-8 py-3 bg-white/10 backdrop-blur-sm rounded-full hover:bg-white/20 transition-colors"
        >
          Discover Those Worlds
        </motion.button>
      </div>
      ...
      >
        ...
        {/* globe svg */}
        <div className="z-10 absolute lg:top-[55%] top-[65%]  left-1/2 transform -translate-x-1/2 w-[600px] h-[600px] backdrop-blur-3xl rounded-full bg-[radial-gradient(circle_at_25%_90%,_#1e386b_15%,_#000000de_70%,_#000000ed_100%)]"></div>
        {/* <div className="z-10 absolute lg:top-[55%] top-[65%] left-1/2 transform -translate-x-1/2 w-[600px] h-[600px] rounded-full overflow-hidden relative">
          {/* Globe image only */}
        {/* <Image
            src="/assets/lightglobe1.png"
            alt="Globe"
            fill
            className="object-contain scale-150" // 👈 increase scale to 125%
            priority
          /> */}
        {/* </div> */}
      </motion.div>
