    ...
    <>
      <div className="fixed bottom-20 right-5 z-[9998]">
        <button
          ...
          className="w-14 h-14 rounded-full shadow-lg hover:scale-105 transition duration-300 bg-primary flex items-center justify-center text-white text-xl font-bold relative"
        >
          <LucideMessageCircleMore className="w-5 h-5" />
          {showPopover && (
            <div className="absolute right-full mr-3 bg-primary text-white text-sm px-4 py-2 rounded-lg shadow-lg whitespace-nowrap animate-bounce transition-all duration-500">
              Contact Us!
            </div>
          )}
        </button>
