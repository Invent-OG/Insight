...
const countries = [
  ...
  },
  {
    ...
    special: 'Ranks 3rd globally for international student satisfaction (ICEF Monitor).',
  },
  {
    country: 'New Zealand',
  ...
  },
  {
    ...
    duration: '2-year post-graduation work visa',
    special: '5th most popular destination for international students globally (UNESCO).',
  },
  {
    country: 'Germany',
    academic: 'Bachelor’s (3-4 years), Master’s (1-2 years)',
    duration: '18-month job-seeking visa',
    special: 'No tuition fees at many public universities and high-demand STEM careers.',
  },
  {
    country: 'UAE',
    academic: 'Bachelor’s (3-4 years), Master’s (1-2 years)',
  ...
  },
  {
    ...
    special: 'Ranked as the 4th best student city globally (QS Best Student Cities 2023).',
  },
  {
    country: 'Malaysia',
    academic: 'Bachelor’s (3-4 years), Master’s (1-2 years)',
    duration: 'Post-graduation work visa options',
    special: 'Affordable tuition and rich cultural environment for international students.',
  },
  {
    country: 'Latvia',
    academic: 'Bachelor’s (3 years), Master’s (1-2 years)',
  ...
  },
  {
    ...
    special: 'One of the fastest-growing economies in the EU, especially in tech and business.',
  },
  {
    country: 'Poland',
    academic: 'Bachelor’s (3 years), Master’s (2 years)',
    duration: 'Work visa opportunities after graduation',
    special: 'Leader in European business education, affordable tuition, and a growing job market.',
  },
  {
    country: 'Other European Countries',
    academic: 'Bachelor’s (3-4 years), Master’s (1-2 years)',
    duration: 'Post-graduation work visas in various countries',
    special: 'Wide range of affordable education options and strong cultural diversity.',
  },
];
...
export default function WhyTheseCountries() {
  ...
  return (
    <section className='p-8 mx-auto mt-8 mb-10 text-white bg-black shadow-2xl lg:mt-10 lg:py-10 rounded-3xl max-w-7xl'>
      <h2 className='mb-8 text-3xl font-bold text-center sm:text-4xl md:text-5xl'>
      ...
      <motion.table
        ...
        className='hidden min-w-full overflow-hidden border-2 border-collapse border-red-500 rounded-xl sm:table'
      >
        <thead>
          <tr className='bg-gray-900'>
            <th className='px-6 py-4 text-left border-b border-red-500'>Country</th>
            <th className='px-6 py-4 text-left border-b border-red-500'>Academic Duration</th>
            <th className='px-6 py-4 text-left border-b border-red-500'>Stay-Back Period</th>
            <th className='px-6 py-4 text-left border-b border-red-500'>Special Feature</th>
          </tr>
        </thead>
        <tbody>
      ...
      <div className='mt-6 space-y-4 sm:hidden'>
        {countries.map((item, index) => (
          <details key={item.country} className='p-4 bg-gray-900 rounded-lg'>
