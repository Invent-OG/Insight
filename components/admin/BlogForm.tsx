...
//                     className="min-h-[100px] resize-y rounded-md border border-gray-300 px-4 py-2 text-base focus:outline-none focus:ring-2 focus:ring-red-500"
//                   />
//                 </FormControl>
//                 <FormMessage />
//               </FormItem>
...
//                   <Textarea
//                     {...field}
//                     placeholder="Write blog content (Markdown supported)"
//                     className="min-h-[300px] resize-y rounded-md border border-gray-300 px-4 py-3 text-base font-medium leading-relaxed focus:outline-none focus:ring-2 focus:ring-red-500"
//                   />
//                 </FormControl>
//                 <FormMessage />
//               </FormItem>
...
//           {/* Content with Rich Editor + Preview */}
//           <FormField
//             control={form.control}
//             name="content"
//             render={({ field }) => (
...
//                     />
//                     {/* Live Preview */}
//                     <div className="border p-4 rounded bg-white shadow-inner overflow-auto prose max-w-none">
